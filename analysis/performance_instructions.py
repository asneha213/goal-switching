...
def plot_performance_instructions(axs=None, cache=False):
    ...
    models = ["Prospective (optimal)", "Participants: No instructions (experiment 1)", "Participants: Instructions (experiment 3)"]
    ...
    plot_comparative_bar_plot(axs, data_, mean_values, std_values,  conditions, models,title=None,
                              ylim= ylim, ylabel="Number of suits", legend=True, legend_font=15, bar_width=0.15)
...
if __name__ == "__main__":
    plot_performance_instructions(axs=None, cache=True)